...
local whatsNew = "[🧰] Just fixed a few errors in the script code that caused slow initialization. There's nothing much new, but still, stay tuned for more updates! :D"
